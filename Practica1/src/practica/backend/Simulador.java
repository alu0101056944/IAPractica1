...
public class Simulador {
	...
	public void ejecutarBusqueda(GUICelda[][] escenario) {
		long tComienzo = System.nanoTime();
		...
		long tFinalPreciso = (tFinal-tComienzo);
		System.out.println("Tiempo de finalizacion medio:" + tFinalPreciso + " tComienzo:" + tComienzo + " tFinal: " + tFinal +
		" sin media:" + (tFinal-tComienzo));
	}
